...
const int avgSmooth = 6;

int sensorValue = 0;
int sensorValue_smooth = 0;

float sensitivity = 400.0 / 500.0; //2800mA per 500mV = 0.2
...
void loop() {
  for (int j=0; j < avgSmooth; j++)
  {
    ...
    sensorValue_smooth += sensorValue;
  }
  sensorValue_smooth = sensorValue_smooth / avgSmooth;
  
  // The on-board ADC is 10-bits -> 2^10 = 1024 -> 5V / 1024 ~= 4.88mV
  // The voltage is in millivolts
  float voltage = 4.88 * sensorValue_smooth;
